---
title: "Team-Draw 4. Hnaseatic Jugger Cup"
...
The data is given as a CSV-file. Teams are ordered alpahbetically by their name and given an id number based on their rank in this order. Additionally the data set contains the column FIX, which indicates if a team is set as a participant and not part of the random draw process - those teams are home-teams from Lübeck, a few invitations for other teams who we like very much or who help us with our tournament-organisation, and newbie teams, whom we want to give a chance to participate for the foirst time. All none FIX teams are part of the random draw.
...
7 teams are set FIX, 12 teams are participating in the random draw, 9 teams will be drawn and 3 will be kicked out from the set (you can reenscribe to the list to participate in the usual succession scheme).
